...
def main_page(request):
    ...
    order1 = Order(id=101, user=user, book=book1, plated_end_at=TEST_DATE,created_at=datetime.datetime(2017, 4, 10, 12, 00, tzinfo=pytz.utc))
    order1.save()
    order2 = Order(id=102, user=user, book=book2, plated_end_at=TEST_DATE,created_at=datetime.datetime(2017, 4, 10, 12, 00, tzinfo=pytz.utc))
    order2.save()
